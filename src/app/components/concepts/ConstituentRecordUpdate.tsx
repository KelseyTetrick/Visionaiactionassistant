      ...
      <div className="bg-[var(--background)] rounded-[var(--radius)] border border-[var(--border)] overflow-hidden" style={{ boxShadow: "var(--elevation-sm)" }}>
        ...
        <div className="p-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[var(--card)] rounded-[var(--radius)] border-2 relative overflow-hidden" style={{ boxShadow: "var(--elevation-sm)", borderColor: "rgba(122, 4, 221, 0.25)" }}>

              {/* AI sparkle badge */}
              <div className="absolute top-0 right-0 px-2 py-0.5 rounded-bl-[var(--radius)] flex items-center gap-1" style={{ backgroundColor: aiUpdateColor, color: "#ffffff" }}>
                <Sparkles size={10} />
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <div className="relative mb-4 p-3 rounded-[var(--radius)]" style={{ backgroundColor: "rgba(122, 4, 221, 0.08)", border: "1px solid rgba(122, 4, 221, 0.15)" }}>
                          <div className="flex items-center gap-1.5 mb-2">
                            <Sparkles size={12} className="text-[#7A04DD]" />
                            <span style={{ fontSize: "11px", fontWeight: "var(--font-weight-semibold)", color: aiUpdateColor }}>Updated by AI · Mar 26, 2026</span>
                          </div>
